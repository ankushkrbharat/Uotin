...
const Homepage = () => {
    ...
    <div>
      ...
      <div className="w-full h-screen flex p-6">
        <div className="w-3/7 gap-3 items-center">
          ...
          <Link to={'/create'} className="flex gap-2 bg-primary px-5 py-2 rounded-full items-center text-3xl hover:bg-secondary" >
  ...
  <path fill-rule="evenodd" d="M12.75 3a.75.75 0 01.75-.75 8.25 8.25 0 018.25 8.25.75.75 0 01-.75.75h-7.5a.75.75 0 01-.75-.75V3z" clip-rule="evenodd" />
          ...
          <p className="hover:text-opacity-75 text-dark cursor-pointer hover:underline">Read more About us</p>
        </div></div>
